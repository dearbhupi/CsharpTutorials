...
namespace DI_rockPaperScissor.Tests
{
    ...
    public class RockPaperScissorTests
    {
        ...
        {
            RockPaperScissor _game = new RockPaperScissor(new ForcedPlayer(Choice.Scissors), new ForcedPlayer(Choice.Paper));
        ...
        {
            RockPaperScissor _game = new RockPaperScissor(new ForcedPlayer(Choice.Paper), new ForcedPlayer(Choice.Rock));
